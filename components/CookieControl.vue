          ...
          <div class="cookieControl__ModalContent">
            <div>
              ...
              <template v-for="type in ['necessary', 'optional']">
                <!-- Template and slot for modifying the cookie sections -->
                <template>
                  <slot name="test" v-bind="{ config: cookies, type: type }">
                    <h3 v-text="cookies.text[type].title" :key="type.id" />
                    <p v-text="cookies.text[type].description" :key="type.id" />
                  </slot>
                </template>
                    ...
                    <template v-if="cookie.cookies">
                      <slot name="cookie" v-bind="{ config: cookie }">
                        <p
                          ...
                          v-html="getDescription(cookie.description)"
                        />
                        <ul>
                          <li
